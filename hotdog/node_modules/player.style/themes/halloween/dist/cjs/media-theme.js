...
var MediaThemeHalloweenElement = class extends import_media_theme_element.MediaThemeElement {
  static template = template;
};
if (import_server_safe_globals.globalThis.customElements && !import_server_safe_globals.globalThis.customElements.get("media-theme-halloween")) {
  import_server_safe_globals.globalThis.customElements.define("media-theme-halloween", MediaThemeHalloweenElement);
}
var media_theme_default = MediaThemeHalloweenElement;
